...
var pong = {
      ...
      return pong.checkChallenge([c1, c2]).then(function () {
        return new Challenge({
          ...
          return pong.setChallenge([c1, c2], challenge._id).then(function () {
            var deferred = Q.defer();
            deferred.resolve({ message: c1 + ' has challenged ' + c2 + ' to a foosball game!', challenge: challenge });
            return deferred.promise;
          });
        });
      });
      ...
      return pong.checkChallenge([c1, c2, c3, c4]).then(function () {
        return new Challenge({
          ...
          return pong.setChallenge([c1, c2, c3, c4], challenge._id).then(function () {
            var deferred = Q.defer();
            deferred.resolve({ message: c1 + ' and ' + c2 + ' have challenged ' + c3 + ' and ' + c4 + ' to a foosball game!', challenge: challenge });
            return deferred.promise;
          });
        });
      });
  ...
  getDuelGif: function (cb) {
    var gifs = [
      ...
      'http://media.giphy.com/media/tnyNinwsUtrwY/giphy.gif',
      'http://media.giphy.com/media/UCuitBL5zBDA4/giphy.gif',
      'http://stream1.gifsoup.com/view/17390/bojan-krkic-foosball-o.gif',
      'http://media.giphy.com/media/REVbAFQCHR5cY/giphy.gif',
      'http://i.imgur.com/Hh2lw5B.gif',
      'http://i.imgur.com/BgA1shl.gif'
    ];
    var deferred = Q.defer();
